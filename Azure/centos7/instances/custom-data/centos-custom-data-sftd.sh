...
echo "Add the ScaleFT Testing yum repo"

sudo rpm --import https://dist-testing.scaleft.com/pki/scaleft_rpm_key.asc

curl -C - https://pkg-testing.scaleft.com/scaleft_yum.repo | sudo tee /etc/yum.repos.d/scaleft.repo
